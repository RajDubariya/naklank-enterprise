  ...
  return (
    <section className="home-products-section">
      <div className="text-center mb-4 mt-3">
        <h2 className="text-3xl md:text-4xl justify-between font-bold text-brand-dark">{data.title}</h2>
        {data.description && <p className="text-gray-600 mb-8">{data.description}</p>}
      </div>
        ...
        {data.products.map((product) => (
          ...
          >
            ...
            <div className="product-info">
              <h3 className="product-title text-lg font-semibold mb-2">{product.title}</h3>
